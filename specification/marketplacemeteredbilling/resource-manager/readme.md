...
These settings apply only when `--tag=package-2018-08-31` is specified on the command line.

``` yaml $(tag) == 'package-2018-08-31'
input-file:
- Microsoft.MarketplaceMeteredBilling/stable/2018-08-31/MeteredBilling.json
```
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-ruby
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_marketplace_metered_billing']
```
...
csharp:
  ...
  namespace: Microsoft.Azure.Management.MarketplaceMeteredBilling
  output-folder: $(csharp-sdks-folder)/marketplacemeteredbilling/Microsoft.Azure.Management.MarketplaceMeteredBilling/src/Generated
...
python:
  ...
  namespace: azure.mgmt.marketplacemeteredbilling
  package-name: azure-mgmt-marketplacemeteredbilling
  clear-output-folder: true
...
python:
  ...
  output-folder: $(python-sdks-folder)/marketplacemeteredbilling/azure-mgmt-marketplacemeteredbilling/azure/mgmt/marketplacemeteredbilling
```
``` yaml $(python) && $(python-mode) == 'create'
python:
  basic-setup-py: true
  output-folder: $(python-sdks-folder)/marketplacemeteredbilling/azure-mgmt-marketplacemeteredbilling
```
...
azure-arm: true
fluent: true
namespace: com.microsoft.azure.management.marketplacemeteredbilling
license-header: MICROSOFT_MIT_NO_CODEGEN
payload-flattening-threshold: 1
output-folder: $(azure-libraries-for-java-folder)/azure-mgmt-marketplacemeteredbilling
```
...
### Tag: package-2018-08-31 and java

These settings apply only when `--tag=package-2018-08-31 --java` is specified on the command line.
Please also specify `--azure-libraries-for-java=<path to the root directory of your azure-sdk-for-java clone>`.

``` yaml $(tag) == 'package-2018-08-31' && $(java) && $(multiapi)
java:
...
input-file:
  - $(this-folder)/Microsoft.MarketplaceMeteredBilling/stable/2018-08-31/Agreements.json
