...
input-file:
- Microsoft.LiftrMeteredBilling/stable/2018-08-31/MeteredBilling.json
```
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-ruby
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_liftr_metered_billing']
```
...
csharp:
  ...
  namespace: Microsoft.Azure.Management.LiftrMeteredBilling
  output-folder: $(csharp-sdks-folder)/liftrmeteredbilling/Microsoft.Azure.Management.LiftrMeteredBilling/src/Generated
...
python:
  ...
  namespace: azure.mgmt.liftrmeteredbilling
  package-name: azure-mgmt-liftrmeteredbilling
  clear-output-folder: true
...
python:
  ...
  output-folder: $(python-sdks-folder)/liftrmeteredbilling/azure-mgmt-liftrmeteredbilling/azure/mgmt/liftrmeteredbilling
```
``` yaml $(python) && $(python-mode) == 'create'
python:
  basic-setup-py: true
  output-folder: $(python-sdks-folder)/liftrmeteredbilling/azure-mgmt-liftrmeteredbilling
```
...
azure-arm: true
fluent: true
namespace: com.microsoft.azure.management.liftrmeteredbilling
license-header: MICROSOFT_MIT_NO_CODEGEN
payload-flattening-threshold: 1
output-folder: $(azure-libraries-for-java-folder)/azure-mgmt-liftrmeteredbilling
```
...
input-file:
  - $(this-folder)/Microsoft.LiftrMeteredBilling/stable/2018-08-31/Agreements.json
