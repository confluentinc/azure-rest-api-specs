...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/marketplacefulfillment/mgmt/2018-08-31/marketplacefulfillment"
    ...
    return err
        ...
        return nil
            ...
            // Operation microsoft.MarketplaceFulfillment REST API operation
            ...
            // Provider - Service provider: Microsoft.MarketplaceFulfillment
            ...
            // OperationListResult result of the request to list MarketplaceFulfillment operations. It contains a list
            // of operations and a URL link to get the next set of results.
            type OperationListResult struct {
            autorest.Response `json:"-"`
            // Value - List of Microsoft.MarketplaceFulfillment operations supported by the Microsoft.MarketplaceFulfillment resource provider.
