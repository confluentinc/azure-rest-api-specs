...
input-file:
- Microsoft.MarketplaceFulfillment/stable/2018-08-31/Fulfillment.json
```
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-ruby
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_marketplace_fulfillment']
```
...
csharp:
  ...
  namespace: Microsoft.Azure.Management.MarketplaceFulfillment
  output-folder: $(csharp-sdks-folder)/marketplacefulfillment/Microsoft.Azure.Management.MarketplaceFulfillment/src/Generated
...
python:
  ...
  namespace: azure.mgmt.marketplacefulfillment
  package-name: azure-mgmt-marketplacefulfillment
  clear-output-folder: true
...
python:
  ...
  output-folder: $(python-sdks-folder)/marketplacefulfillment/azure-mgmt-marketplacefulfillment/azure/mgmt/marketplacefulfillment
```
``` yaml $(python) && $(python-mode) == 'create'
python:
  basic-setup-py: true
  output-folder: $(python-sdks-folder)/marketplacefulfillment/azure-mgmt-marketplacefulfillment
```
...
azure-arm: true
fluent: true
namespace: com.microsoft.azure.management.marketplacefulfillment
license-header: MICROSOFT_MIT_NO_CODEGEN
payload-flattening-threshold: 1
output-folder: $(azure-libraries-for-java-folder)/azure-mgmt-marketplacefulfillment
```
...
input-file:
  - $(this-folder)/Microsoft.MarketplaceFulfillment/stable/2018-08-31/Agreements.json
